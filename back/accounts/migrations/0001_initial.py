# Generated by Django 5.1.7 on 2026-04-02 08:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, unique=True, verbose_name='Сургуулийн нэр')),
                ('address', models.CharField(blank=True, max_length=500, null=True, verbose_name='Хаяг')),
                ('admin_email', models.EmailField(max_length=254, unique=True, verbose_name='Админ и-мэйл')),
                ('status', models.CharField(choices=[('pending', 'Хүлээгдэж буй'), ('approved', 'Баталгаажсан'), ('rejected', 'Татгалзсан')], default='pending', max_length=20, verbose_name='Төлөв')),
